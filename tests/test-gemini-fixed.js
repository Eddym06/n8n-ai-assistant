...
/**
 * 🧪 Test de integración con Gemini 2.5 Flash Lite - VERSIÓN ARREGLADA
 */
...
`;
        ...
        try {
            ...
            // Regex CORRECTA sin escapes extras
...
async function runTests() {
    console.log('🚀 Ejecutando tests de integración Gemini - VERSIÓN ARREGLADA\n');
    ...
    if (connectionOk) {
        ...
        console.log('🎉 Integración con Gemini AI lista para usar en el auto-scraper!');
    } else {
